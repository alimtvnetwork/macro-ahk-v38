...
#   curl -fsSL https://github.com/alimtvnetwork/macro-ahk-v33/releases/download/v2.158.0/install.sh | bash
#
#   # From main (latest channel):
#   curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v33/main/scripts/install.sh | bash
#
#   # Explicit override:
...
REPO="${MARCO_DEFAULT_REPO:-alimtvnetwork/macro-ahk-v33}"
